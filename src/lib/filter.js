 ...
 */
System.register(["./window"], function(exports_1) {
    "use strict";
    var window_1;
    var FIR, Biquad;
    /**
    ...
    function newFilter13(coeffs) {
        var c0 = coeffs[0], c1 = coeffs[1], c2 = coeffs[2], c3 = coeffs[3], c4 = coeffs[4], c5 = coeffs[5], c6 = coeffs[6], c7 = coeffs[7], c8 = coeffs[8], c9 = coeffs[9], c10 = coeffs[10], c11 = coeffs[11], c12 = coeffs[12];
        var r0 = 0, r1 = 0, r2 = 0, r3 = 0, r4 = 0, r5 = 0, r6 = 0, r7 = 0, r8 = 0, r9 = 0, r10 = 0, r11 = 0, r12 = 0;
        var i0 = 0, i1 = 0, i2 = 0, i3 = 0, i4 = 0, i5 = 0, i6 = 0, i7 = 0, i8 = 0, i9 = 0, i10 = 0, i11 = 0, i12 = 0;
        return {
            update: function (v) {
                r12 = r11;
                r11 = r10;
    ...
    function genCoeffs(size, window, func) {
        window = window || window_1.Window.hann;
        var W = window(size);
        var center = size * 0.5;
        var sum = 0.0;
        var arr = [];
    ...
    return {
        ...
        execute: function() {
            FIR = (function () {
                ...
                FIR.average = function (size, window) {
                    var omega = 1.0 / size;
                ...
                FIR.boxcar = function (size, window) {
                    var coeffs = genCoeffs(size, window, function (i) {
                        return 1.0;
                    });
                    return (size === 13) ? newFilter13(coeffs) : newFilter(size, coeffs);
                };
                FIR.lowpass = function (size, cutoffFreq, sampleRate, window) {
                ...
                FIR.highpass = function (size, cutoffFreq, sampleRate, window) {
                    var omega = 2.0 * Math.PI * cutoffFreq / sampleRate;
                    var coeffs = genCoeffs(size, window, function (i) {
                ...
                FIR.bandpass = function (size, loCutoffFreq, hiCutoffFreq, sampleRate, window) {
                ...
                FIR.bandreject = function (size, loCutoffFreq, hiCutoffFreq, sampleRate, window) {
                    var omega1 = 2.0 * Math.PI * hiCutoffFreq / sampleRate;
                    var omega2 = 2.0 * Math.PI * loCutoffFreq / sampleRate;
                    var coeffs = genCoeffs(size, window, function (i) {
                ...
                FIR.raisedcosine = function (size, rolloff, symbolFreq, sampleRate, window) {
            ...
            Biquad = (function () {
                ...
                Biquad.lowPass = function (frequency, sampleRate, q) {
                ...
                Biquad.highPass = function (frequency, sampleRate, q) {
                    q = typeof q !== 'undefined' ? q : 0.707;
                    var freq = 2.0 * Math.PI * frequency / sampleRate;
                    var alpha = Math.sin(freq) / (2.0 * q);
                    var b0 = (1.0 + Math.cos(freq)) / 2.0;
                ...
                Biquad.bandPass = function (frequency, sampleRate, q) {
                ...
                Biquad.bandReject = function (frequency, sampleRate, q) {
                    q = typeof q !== 'undefined' ? q : 0.5;
                    var freq = 2.0 * Math.PI * frequency / sampleRate;
                    var alpha = Math.sin(freq) / (2.0 * q);
                    var b0 = 1.0;
