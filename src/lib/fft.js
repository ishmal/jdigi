 ...
 */
System.register(["./complex", "./window"], function(exports_1) {
    "use strict";
    var complex_1, window_1;
    /**
    ...
    function FFT(N) {
        ...
        function generateStageData() {
            ...
            for (var stage = 0; stage < nrStages; stage++, span <<= 1, wspan >>= 1) {
                var stageData = [];
                for (var submatrix = 0; submatrix < N2 / span; submatrix++) {
                    var np = submatrix * span * 2;
                    var ni = np;
                    for (var node = 0; node < span; node++) {
                        var l = ni;
                        var r = ni + span;
                        var idx = node * wspan;
    ...
    function SimpleGoertzel(frequency, binWidth, sampleRate) {
        ...
        //for complex values
        this.magX = function () {
            return complex_1.ComplexOps.mag(this.X());
        };
    ...
    return {
        ...
        execute: function() {
            exports_1("FFT", FFT);
            exports_1("FFTSR", FFTSR);
            exports_1("SimpleGoertzel", SimpleGoertzel);
        }
    }
});
