System.register(["./fsk"], function(exports_1) {
    ...
    var fsk_1;
    var NUL, SPACE, CR, LF, LTRS, FIGS, ALPHA, BETA, SYNC, REPEAT, CCIR, RxSync1, RxSync2, RxData, ResultOk, ResultSoft, ResultFail, ResultEom, NavtexMode;
    function createCCIR() {
        var t = [];
        t[0x3a] = ['Q', '1'];
        /*0111010*/
    ...
    return {
        ...
        execute: function() {
             ...
             *
             */
            NavtexMode = (function (_super) {
                __extends(NavtexMode, _super);
                function NavtexMode(par) {
                    _super.call(this, par, NavtexMode.props);
                ...
                NavtexMode.props = function (self) {
                    return {
                        name: "navtex",
                ...
                NavtexMode.prototype.shift7 = function (bit) {
                    var a = (bit) ? 1 : 0;
                    var b = (this._sync1 >> 6) & 1;
                ...
                NavtexMode.prototype.processBit = function (bit) {
                    ...
                    switch (this._state) {
                        ...
                        case RxData:
                            ...
                            //trace("code: " + code);
                            if (++this._bitcount >= 7) {
                                if (this.processCode(this._code) != ResultFail) {
                ...
                NavtexMode.prototype.qadd = function (v) {
                    this._q3 = this._q2;
                    this._q2 = this._q1;
                    this._q1 = v;
                };
                NavtexMode.prototype.processCode = function (code) {
                ...
                NavtexMode.prototype.processCode2 = function (code) {
                    var res = '@';
                    if (code === 0) {
                    }
                    else if (code < 0) {
            ...
            exports_1("NavtexMode", NavtexMode); // NavtexMode
        }
    }
});
//# sourceMappingURL=navtex.js.map